...
async Task<DocInterfaceControl> Console_InitializeDocInterfaceControlAsync()
{
...
async Task<bool> Console_ExecuteAndContinueAsync(DocInterfaceControl _docIntControl)
{
    //Main Console MENU
    Console.WriteLine("");
    Console.WriteLine("--------------------");
...
async Task Console_Execute_ReadReaderIDAsync(DocInterfaceControl _docIntControl)
{
...
async Task Console_Execute_IdentifyAsync(DocInterfaceControl _docIntControl)
{
    m_LastTagID = null;
    //First make sure DocInterfaceControl is initialized
    if (_docIntControl != null)
        ...
        if (_docIntControl.IsInitialized)
        {
            try
            {
                ...
                if (tagScanInfo != null)
                {
                    ...
                    if (tagScanInfo is HfScanResultInfo hfResult)
                    {
                        m_LastTagID = hfResult.TagID;
                    }
                    if (tagScanInfo is UhfScanResultInfo uhfScan)
                    {
...
async Task Console_Execute_ReadBytesAsync(DocInterfaceControl _docIntControl)
{
...
async Task Console_Execute_WriteBytesAsync(DocInterfaceControl _docIntControl)
{
