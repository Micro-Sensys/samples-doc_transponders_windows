...
#Region "Initialize"
    Private Async Sub ButtonInitialize_ClickAsync(sender As Object, e As RoutedEventArgs)
        ...
        Try
            ...
            '   1356 = 13.56MHz (HF)
            '   868 = 868MHz (UHF)
            Dim interfaceType As Integer = InterfaceTypeEnum.Interface_HF
...
#End Region
    ...
    Private Async Sub Button_Identify_ClickAsync(sender As Object, e As RoutedEventArgs)
        ...
        If m_DocInterface IsNot Nothing Then
            If m_DocInterface.IsInitialized Then
                ...
                Try
                    ...
                    Dim identifyResult = Await m_DocInterface.IdentifyAsync()
    ...
    Private Async Sub Button_ReadBytes_ClickAsync(sender As Object, e As RoutedEventArgs)
        ...
        If m_DocInterface IsNot Nothing Then
            If m_DocInterface.IsInitialized Then
                ...
                Try
                    ...
                    Dim result = Await m_DocInterface.ReadBytesAsync(tagID, page, from, length)
                    Dim processSpan = DateTime.UtcNow - startTime
    ...
    Private Async Sub Button_WriteBytes_ClickAsync(sender As Object, e As RoutedEventArgs)
        If comboBox_TagID.SelectedIndex = -1 Then
        ...
        If m_DocInterface IsNot Nothing Then
            If m_DocInterface.IsInitialized Then
                ...
                Try
                    ...
                    Dim result = Await m_DocInterface.WriteBytesAsync(tagID, page, from, dataToWrite, False)
                    Dim processSpan = DateTime.UtcNow - startTime
